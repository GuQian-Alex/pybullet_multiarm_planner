...
from planners.rrt_utils import irange, argmin
...
class RRTPlanner:
    ...
    def plan(
        ...
        :param distance: distance function distance(q1, q2). Takes two configurations, returns a number of distance
        ...
        :param iterations: number of iterations to extend tree towards a sample
        ...
        for i in range(iterations):
            if i % 20 == 0:
                    print(f"RRT iter={i},20 iterations finished! ")
